...
import { W as WithRetryOptions } from '../retry-tolliO-l.js';
...
>;
declare const companyChannelsRelations: drizzle_orm.Relations<
  'company_channels',
  {
    company: drizzle_orm.One<'companies', true>;
  }
...
>;
declare const subscriptionTransactionsRelations: drizzle_orm.Relations<
  'subscription_transactions',
  {
    company: drizzle_orm.One<'companies', true>;
  }
>;
declare const eventLogsRelations: drizzle_orm.Relations<
  'event_logs',
  {
    company: drizzle_orm.One<'companies', false>;
  }
>;
declare const metricsRelations: drizzle_orm.Relations<
  'metrics',
  {
    company: drizzle_orm.One<'companies', false>;
  }
>;
declare const ledgerTransactionsRelations: drizzle_orm.Relations<
  'ledger_transactions',
  {
    company: drizzle_orm.One<'companies', true>;
  }
 ...
 */
declare function createEncryptor(
  currentKey: string,
  previousKey?: string,
): {
 ...
 */
declare function getTotalPaidForDeliveries(
  deliveryIds: string[],
  conn: DrizzleDB,
 ...
 */
declare function applyPaymentStatusUpdate(
  tx: DrizzleDB,
  deliveryIds: string[],
  companyId: string | null,
): Promise<string[]>;
 ...
 */
declare function computeAllocationTargets(
 ...
 */
declare function processPaymentAllocation(
  tx: DrizzleDB,
 ...
 */
declare function computePoolSplit(
  amountToApply: number,
 ...
 */
declare function deleteSupabaseUser(
...
export {
  ...
  type PaymentAllocationTransaction,
  PermanentJobError,
  type QueueHandler,
