 ...
 */
interface DefaultPricingScheme {
 ...
 */
declare const DEFAULT_PRICING_SCHEMES: readonly DefaultPricingScheme[];
/**
 * Default system company handle.
 */
declare const SYSTEM_COMPANY_HANDLE: string;
/**
 * Default system subscription tier applied to the Central Hub company.
 */
declare const SYSTEM_SUBSCRIPTION_TIER = SubscriptionTier.PROFESSIONAL;
/**
...
declare const DEFAULT_SYSTEM_COMPANY: DefaultSystemCompany;
...
declare const role: drizzle_orm_pg_core.PgEnum<["DISPATCHER", "COMPANY", "RIDER", "CUSTOMER", "ADMIN"]>;
...
declare const companiesRelations: drizzle_orm.Relations<"companies", {
    companySettings: drizzle_orm.Many<"company_settings">;
