...
declare const DEFAULT_WORKING_HOURS: Record<
  string,
  {
    start: string;
    close: string;
 ...
 */
declare function shouldRetryPayment(
...
declare const deliveryStatus: drizzle_orm_pg_core.PgEnum<
  ['AWAITING_PAYMENT', 'PENDING', 'ASSIGNED', 'IN_TRANSIT', 'DELIVERED', 'CANCELLED']
>;
declare const exportRequestStatus: drizzle_orm_pg_core.PgEnum<
  ['PENDING', 'PROCESSING', 'COMPLETED', 'FAILED']
>;
declare const ledgerAdjustmentType: drizzle_orm_pg_core.PgEnum<
  ['CREDIT', 'DEBIT', 'CORRECTION', 'REFUND']
>;
declare const mappingPlatform: drizzle_orm_pg_core.PgEnum<
...
declare const transactionStatus: drizzle_orm_pg_core.PgEnum<
...
declare const companySettingsRelations: drizzle_orm.Relations<
  'company_settings',
  {
    company: drizzle_orm.One<'companies', true>;
  }
>;
declare const companiesRelations: drizzle_orm.Relations<
  'companies',
  {
...
>;
declare const pricingSchemesRelations: drizzle_orm.Relations<
  'pricing_schemes',
  {
    company: drizzle_orm.One<'companies', true>;
  }
>;
declare const companyIntegrationsRelations: drizzle_orm.Relations<
  'company_integrations',
  {
    company: drizzle_orm.One<'companies', true>;
  }
>;
declare const conversationsRelations: drizzle_orm.Relations<
  'conversations',
  {
...
>;
declare const messagesRelations: drizzle_orm.Relations<
  'messages',
  {
    conversation: drizzle_orm.One<'conversations', true>;
  }
>;
declare const dispatchersRelations: drizzle_orm.Relations<
  'dispatchers',
  {
    company: drizzle_orm.One<'companies', false>;
  }
>;
declare const deliveriesRelations: drizzle_orm.Relations<
  'deliveries',
  {
    company: drizzle_orm.One<'companies', false>;
...
>;
declare const ridersRelations: drizzle_orm.Relations<
  'riders',
  {
    deliveries: drizzle_orm.Many<'deliveries'>;
    company: drizzle_orm.One<'companies', false>;
...
>;
declare const deliveryAllocationsRelations: drizzle_orm.Relations<
...
>;
declare const deliveryTransactionsRelations: drizzle_orm.Relations<
  'delivery_transactions',
  {
    deliveryAllocations: drizzle_orm.Many<'delivery_allocations'>;
  }
>;
declare const customerCompanyMappingsRelations: drizzle_orm.Relations<
  'customer_company_mappings',
  {
    company: drizzle_orm.One<'companies', true>;
  }
>;
declare const riderLocationLogsRelations: drizzle_orm.Relations<
  'rider_location_logs',
  {
