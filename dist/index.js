...
__export(index_exports, {
  ...
  isDeliveryTerminal: () => isDeliveryTerminal,
  ledgerAdjustmentType: () => ledgerAdjustmentType,
...
var SYSTEM_CONFIG =
  typeof process !== 'undefined' ? buildSystemConfig(process.env) : buildSystemConfig();
...
var securityConfigSchema = import_zod4.z.object({
  rateLimits: import_zod4.z.object({
    ...
    tiers: import_zod4.z.object({
      ...
      STARTER: import_zod4.z.object({
        max: import_zod4.z.number(),
        windowMs: import_zod4.z.number(),
      }),
      PROFESSIONAL: import_zod4.z.object({
        max: import_zod4.z.number(),
        windowMs: import_zod4.z.number(),
      }),
    }),
...
function localParse(text2) {
  ...
  for (const block of dropoffBlocks) {
    ...
    const dAddress = dAddressMatch
      ...
      : block
          .split('\n')[0]
          .replace(/(?:Dropoff|Delivery)\s*\d*:/i, '')
          .trim();
...
var messageStatus = (0, import_pg_core.pgEnum)('MessageStatus', [
  'SENT',
  'DELIVERED',
  'READ',
  'FAILED',
...
var senderType = (0, import_pg_core.pgEnum)('SenderType', [
  'CUSTOMER',
  'AGENT',
  'DISPATCHER',
  'SYSTEM',
]);
var subscriptionTier = (0, import_pg_core.pgEnum)('SubscriptionTier', [
  'FREE',
  'STARTER',
  'PROFESSIONAL',
]);
...
var companies = (0, import_pg_core.pgTable)(
  'companies',
  {
    ...
    createdAt: (0, import_pg_core.timestamp)('created_at', { precision: 3, mode: 'date' })
      .default(import_drizzle_orm.sql`CURRENT_TIMESTAMP`)
      .notNull(),
  },
  (table) => [
    ...
    (0, import_pg_core.index)('companies_name_idx').using(
      'btree',
      table.name.asc().nullsLast().op('text_ops'),
    ),
    (0, import_pg_core.index)('companies_states_gin_idx').using('gin', table.states),
  ],
);
var companySettings = (0, import_pg_core.pgTable)(
  'company_settings',
  {
    ...
    workingHours: (0, import_pg_core.jsonb)('working_hours')
      .default({
...
var companyIntegrations = (0, import_pg_core.pgTable)(
  ...
  (table) => [
    ...
    (0, import_pg_core.index)('company_integrations_company_id_is_active_idx').using(
      'btree',
      table.companyId.asc().nullsLast().op('text_ops'),
      table.isActive.asc().nullsLast().op('bool_ops'),
    ),
...
var conversations = (0, import_pg_core.pgTable)(
  'conversations',
  {
    ...
    lastMessageAt: (0, import_pg_core.timestamp)('last_message_at', { precision: 3, mode: 'date' })
      .default(import_drizzle_orm.sql`CURRENT_TIMESTAMP`)
      .notNull(),
    createdAt: (0, import_pg_core.timestamp)('created_at', { precision: 3, mode: 'date' })
      .default(import_drizzle_orm.sql`CURRENT_TIMESTAMP`)
    ...
    lastCustomerMessageAt: (0, import_pg_core.timestamp)('last_customer_message_at', {
      precision: 3,
      mode: 'date',
    }),
  ...
  (table) => [
    ...
    (0, import_pg_core.index)('conversations_auto_reply_disabled_idx')
      .on(table.companyId, table.lastMessageAt)
      .where(import_drizzle_orm.sql`auto_reply_enabled = false AND company_id IS NULL`),
    (0, import_pg_core.foreignKey)({
      columns: [table.companyId],
      foreignColumns: [companies.id],
...
var messages = (0, import_pg_core.pgTable)(
  'messages',
  {
    ...
    createdAt: (0, import_pg_core.timestamp)('created_at', { precision: 3, mode: 'date' })
      .default(import_drizzle_orm.sql`CURRENT_TIMESTAMP`)
      .notNull(),
    updatedAt: (0, import_pg_core.timestamp)('updated_at', { precision: 3, mode: 'date' })
      .default(import_drizzle_orm.sql`CURRENT_TIMESTAMP`)
      .notNull(),
  },
  (table) => [
...
var admins = (0, import_pg_core.pgTable)(
  ...
  (table) => [
    (0, import_pg_core.uniqueIndex)('admins_email_key').using(
      'btree',
      table.email.asc().nullsLast().op('text_ops'),
    ),
    (0, import_pg_core.uniqueIndex)('admins_user_id_key').using(
      'btree',
...
var deliveries = (0, import_pg_core.pgTable)(
  ...
  (table) => [
    ...
    (0, import_pg_core.index)('deliveries_status_idx').using(
      'btree',
      table.status.asc().nullsLast().op('enum_ops'),
    ),
...
var riders = (0, import_pg_core.pgTable)(
  ...
  (table) => [
    ...
    (0, import_pg_core.uniqueIndex)('riders_email_key').using(
      'btree',
      table.email.asc().nullsLast().op('text_ops'),
    ),
    ...
    (0, import_pg_core.uniqueIndex)('riders_user_id_key').using(
      'btree',
      table.userId.asc().nullsLast().op('text_ops'),
    ),
    (0, import_pg_core.foreignKey)({
...
var deliveryAllocations = (0, import_pg_core.pgTable)(
  ...
  (table) => [
    (0, import_pg_core.uniqueIndex)(
      'delivery_allocations_delivery_id_delivery_transaction_id_key',
    ).using(
      'btree',
...
var exportRequests = (0, import_pg_core.pgTable)(
  'export_requests',
  {
    ...
    riderId: (0, import_pg_core.text)('rider_id'),
    requestedAt: (0, import_pg_core.timestamp)('requested_at', { precision: 3, mode: 'date' })
      .default(import_drizzle_orm.sql`CURRENT_TIMESTAMP`)
      .notNull(),
...
var subscriptionTransactions = (0, import_pg_core.pgTable)(
  'subscription_transactions',
  {
    ...
    periodStart: (0, import_pg_core.timestamp)('period_start', {
      precision: 3,
      mode: 'date',
    }).notNull(),
    periodEnd: (0, import_pg_core.timestamp)('period_end', {
      precision: 3,
      mode: 'date',
    }).notNull(),
    metadata: (0, import_pg_core.jsonb)(),
...
var customerCompanyMappings = (0, import_pg_core.pgTable)(
  ...
  (table) => [
    ...
    (0, import_pg_core.uniqueIndex)(
      'customer_company_mappings_platform_id_platform_company_id_key',
    ).using(
      'btree',
      table.platformId.asc().nullsLast().op('text_ops'),
      table.platform.asc().nullsLast().op('enum_ops'),
...
var companyIntegrationsRelations = (0, import_relations.relations)(
  companyIntegrations,
  ({ one }) => ({
    company: one(companies, {
...
var deliveryAllocationsRelations = (0, import_relations.relations)(
  deliveryAllocations,
  ({ one }) => ({
...
var deliveryTransactionsRelations = (0, import_relations.relations)(
  deliveryTransactions,
  ({ many }) => ({
    deliveryAllocations: many(deliveryAllocations),
  }),
);
var customerCompanyMappingsRelations = (0, import_relations.relations)(
